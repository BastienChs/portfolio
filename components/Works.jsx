    ...
    return(
        <div className="container mt-64 flex justify-between items-center mx-auto px-8 md:px-14 lg:px-24 w-full">
            <section className="w-full">
                ...
                <p className="section-paragraph">I’ve had the pleasure of working with multiple Fortune 500 companies,
                    designing and implementing both frontend and backend.</p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
                    <img
                        ...
                        className="w-full bg-nav h-36 lg:h-72 object-cover" alt={"1"}/>
                        <img
                            ...
                            <img
                                ...
                                className="w-full hidden md:block bg-nav h-36 lg:h-72 object-cover" alt={"1"}/>
                                <img
                                            ...
                                            <img
                                                ...
                                                <img
                                                    ...
                                                    <img
                                                        ...
                                                        className="w-full hidden md:block md:col-span-2 lg:col-span-1 bg-nav h-36 lg:h-72 object-cover" alt={"1"}/>
                </div>
            </section>
        </div>
    )
