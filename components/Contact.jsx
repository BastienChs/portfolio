                ...
                <div className="w-full grid lg:grid-cols-2 gap-8 lg:gap-32 mt-24">
                    ...
                    <div className="mt-12">
                        ...
                        <a href="mailto:email@mydomain.com"
                           className="text-secondary underline mt-3 block">email@mydomain.com</a>
                        <div className="flex mt-20 space-x-6">
                            <a href="#">
                                <svg className="w-8 h-8 lg:w-12 lg:h-12" width="50" height="50" viewBox="0 0 50 50"
                            ...
                            <a href="#">
                                <svg className="w-8 h-8 lg:w-12 lg:h-12" width="42" height="42" viewBox="0 0 42 42"
                                     fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
